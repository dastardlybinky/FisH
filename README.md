...
## rdf.py
python rdf.py sim_output --sys-type solo --placement-combos --traj-cap 3 --rdf-output solo-rdf.png --chunked-chains

python rdf.py sim_output --sys-type combo --placement-combos --chunked-chains --traj-cap 3 --rdf-output combo-rdf.png
